...
public class ModdedVillagerTrades extends VillagerTrades {

    public static final Int2ObjectMap<ItemListing[]> NETHER_WANDERING_TRADER_TRADES = toIntMap(ImmutableMap.of(
        1, new VillagerTrades.ItemListing[]{
            new ModdedVillagerTrades.ItemsForEmeralds(Items.NETHER_GOLD_ORE, 2, 1, 5, 1),
            new ModdedVillagerTrades.ItemsForEmeralds(Items.NETHER_QUARTZ_ORE, 4, 1, 5, 1),
            new ModdedVillagerTrades.ItemsForEmeralds(Items.NETHER_WART, 2, 1, 5, 1),
            new ModdedVillagerTrades.ItemsForEmeralds(Items.NETHERITE_SCRAP, 5, 1, 5, 1),
            new ModdedVillagerTrades.ItemsForEmeralds(Items.RED_NETHER_BRICK_SLAB, 1, 1, 12, 1)},
    ...
    // Copy of static class from VillagerTrades
