...
public class TiersMod {
    ...
    private void commonSetup(final FMLCommonSetupEvent event)
    {
        ...
        if (ToolStatsConfig.logDirtBlock)
            LOGGER.info("DIRT BLOCK >> {}", ForgeRegistries.BLOCKS.getKey(Blocks.DIRT));

        LOGGER.info(ToolStatsConfig.magicNumberIntroduction + ToolStatsConfig.magicNumber);

        ToolStatsConfig.items.forEach((item) -> LOGGER.info("ITEM >> {}", item.toString()));
    }
